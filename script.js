...
document.querySelectorAll('a, button, .sn-mod, .proj-card, .stat-card').forEach(el => {
...
console.log('%c  ServiceNow Micro-Certified · CSA Path  ', 'color:#9f7aea;font-family:monospace;font-size:10px;');
